...
export default async function ProductsPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div>
      <div className="mx-auto max-w-[var(--container-shop)] px-4 sm:px-6 lg:px-15 pt-8">
      ...
      <Suspense
        fallback={<div className="mx-auto mt-6 h-[62px] max-w-[var(--container-shop)] border-b border-black/10 px-4 sm:px-6 lg:px-15" />}
      >
        <FilterSortBar />
      </Suspense>

      <div className="mx-auto max-w-[var(--container-shop)] px-4 sm:px-6 lg:px-15 pb-16">
        {sorted.length > 0 ? (
