  ...
  return (
    <div>
      ...
      {presentCategories.map((category) => {
        // 4 cột × 2 hàng = 8 sản phẩm mỗi danh mục trên desktop (khớp đúng
        // lg:grid-cols-4 bên dưới, không dư ô lẻ) — nhiều hơn thì dùng nút
        // "Xem thêm" đã có sẵn để qua trang danh mục đầy đủ.
